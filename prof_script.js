$(function() {
    ...
    var $borderWidth = $(window).width();

    $('.border-top').css('border-top', '100px solid transparent').css('border-right', `${$borderWidth}solid  rgba(110, 144, 255, 0.534)`);
    ...
    $(window).scroll(function() {
        ...
        if(scrollTopValue > 600){
            $('.name-container').fadeIn().animate({left: 0}, 200);
            $('.fish1').animate({left: 100 + '%'}, 2000);
            $('.fish2').animate({left: 100 + '%'}, 1800);
        }
    });
